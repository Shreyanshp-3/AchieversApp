    ...
    return (
        <Box>
            ...
            >
                ...
                <Box flex="1" mb={-10}>
                    ...
                    <Text fontSize="md" color="gray.700" mb={6} textAlign="justify">
                        In the dense overseas education industry, Global Achievers stands tall with a formidable reputation, crafted over 25 years of immaculate counseling experience. An honest approach towards test prep, university shortlisting, and holistic application guidance, Global Achievers continues in its journey of helping students realize their full potential and landing them opportunities that they truly deserve. So, your quest for a truly invested partner to guide you towards your overseas education dreams ends here.                    
                    </Text>
                    <Text fontSize="md" color="gray.700" mb={6} textAlign="justify">
            ...
            <Box px={{ base: 4, md: 16 }} pb={20} textAlign="center">
                ...
                <Flex justify="center" gap={{ base: 2, md: 20 }} wrap="wrap">
                    {/* Trainer 1 */}
                    <Box maxW="300px" mx={{ base: "auto", md: 0 }} mb={8} textAlign="center" position="relative">
...
//           </Heading>
//           <Text fontSize="md" color="gray.700" mb={6} textAlign="justify">
//             In the dense overseas education industry, Global Achievers stands
//             tall with a formidable reputation, crafted over 25 years of
//             immaculate counseling experience. An honest approach towards test
//             prep, university shortlisting, and holistic application guidance,
//             Global Achievers continues in its journey of helping students
//             realize their full potential and landing them opportunities that
//             they truly deserve. So, your quest for a truly invested partner to
//             guide you towards your overseas education dreams ends here.
//           </Text>
//           <Text fontSize="md" color="gray.700" mb={6} textAlign="justify">
//             Thoroughly individual approach, personal accountability, and
//             consistent mentorship have earned us tremendous credibility in the
//             industry. Join us and experience reliable support every step of the
//             way.
//           </Text>
...
//                 <center>
//                   <Link
//                     href="https://www.linkedin.com/in/ananya-desai"
//                     isExternal
//                     color="#024877"
//                     fontSize="2xl"
//                   >
